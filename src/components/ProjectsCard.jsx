    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 lg:h-96 bg-secondary shadow-md shadow-primary">
            ...
            <div className="grid grid-cols-1 p-10 lg:col-span-2">
                <h2 className="text-3xl uppercase m-1 text-white font-bold text-center font-helvetica">{project.projectTitle}</h2>
                <p className="text-base m-1 my-5 text-white text-justify font-roboto">{project.projectSummary}</p>
