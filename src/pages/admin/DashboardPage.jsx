    ...
    <div className="container mx-auto bg-tertiary pt-24">
      {
        loading ?
          ...
          <div>
              ...
              <div className="w-full sm:w-40">
                ...
                <div className="flex justify-center">
                  <NavLink to="/admin/messages">
                    <button
                      className="w-28 h-28 m-2 border border-black bg-secondary hover:bg-tertiary font-semibold text-2xl rounded-full"
                    >
            ...
            <div className="flex flex-wrap justify-center">
              <div className="w-full sm:w-40">
                <p className="text-white font-semibold text-2xl text-center">Home Page</p>
                <div className="flex justify-center">
                  <NavLink to="/admin/home">
                    <button
                      className="w-28 h-28 m-2 border border-black bg-secondary hover:bg-tertiary font-semibold text-2xl rounded-full bg-edit bg-no-repeat bg-contain"
                    >
                    </button>
                  </NavLink>
                </div>
              ...
              <div className="w-full sm:w-40">
                <p className="text-white font-semibold text-2xl text-center">Sobre mí</p>
                <div className="flex justify-center">
